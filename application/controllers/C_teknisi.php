...
class C_teknisi extends CI_Controller {
	...
	{
		$this->load->view('admin/teknisi/inc/head');
		$this->load->view('admin/teknisi/inc/sidebar');
		$this->load->view('admin/teknisi/das/dashboard');
		$this->load->view('admin/teknisi/inc/footer');
	}
	else
	{
		redirect("C_login");
		...
		if($this->M_login->logged_id2() == 'teknisi')
	{
		...
		$this->load->view('admin/teknisi/inc/head');
		$this->load->view('admin/teknisi/inc/sidebar');
		$this->load->view('admin/teknisi/data/in_client',$data);
		$this->load->view('admin/teknisi/inc/footer');
	}
	else
	{
	...
	public function penawaran()
	{
		if($this->M_login->logged_id2() == 'teknisi')
	{
		$data['user'] = $this->M_teknisi->tampil_data_penawaran()->result();
		$data['user2'] = $this->M_teknisi->tampil_data_client()->result();
		$this->load->view('admin/teknisi/inc/head');
		$this->load->view('admin/teknisi/inc/sidebar');
		$this->load->view('admin/teknisi/data/penawaran',$data);
		$this->load->view('admin/teknisi/inc/footer');
	}
	else
	{
...
public function jasa()
	{
		if($this->M_login->logged_id2() == 'teknisi')
	{
		$data['user'] = $this->M_teknisi->tampil_data_jasa()->result();
		$this->load->view('admin/teknisi/inc/head');
		$this->load->view('admin/teknisi/inc/sidebar');
		$this->load->view('admin/teknisi/data/jasa',$data);
		$this->load->view('admin/teknisi/inc/footer');
	}
	else
	{
...
public function v_order()
	{
		if($this->M_login->logged_id2() == 'teknisi')
	{
		$data['user'] = $this->M_teknisi->tampil_data_vo1();
		$data['user2'] = $this->M_teknisi->tampil_data_client()->result();
		$data['user3'] = $this->M_teknisi->tampil_data_vo();
		$this->load->view('admin/teknisi/inc/head');
		$this->load->view('admin/teknisi/inc/sidebar');
		$this->load->view('admin/teknisi/data/v_order',$data);
		$this->load->view('admin/teknisi/inc/footer');
	}
	else
	{
...
public function lwo()
	{
		if($this->M_login->logged_id2() == 'teknisi')
	{
		$data['user'] = $this->M_teknisi->tampil_data_lwo()->result();
		$data['user2'] = $this->M_teknisi->tampil_data_client()->result();
		$this->load->view('admin/teknisi/inc/head');
		$this->load->view('admin/teknisi/inc/sidebar');
		$this->load->view('admin/teknisi/data/lwo',$data);
		$this->load->view('admin/teknisi/inc/footer');
	}
	else
	{
...
public function monitoring()
		...
		if($this->M_login->logged_id2() == 'teknisi')
	{
		...
		$this->load->view('admin/teknisi/inc/head');
		$this->load->view('admin/teknisi/inc/sidebar');
		$this->load->view('admin/teknisi/data/monitoring',$data);
		$this->load->view('admin/teknisi/inc/footer');
	}
	else
	{
		...
		if($this->M_login->logged_id2() == 'teknisi')
	{
		...
		$this->load->view('admin/teknisi/inc/head');
		$this->load->view('admin/teknisi/inc/sidebar');
		$this->load->view('admin/teknisi/data/mekanik',$data);
		$this->load->view('admin/teknisi/inc/footer');
	}
	else
	{
	...
	public function user()
	{
		if($this->M_login->logged_id2() == 'teknisi')
	{
		$data['user'] = $this->M_teknisi->tampil_data_user();
		$this->load->view('admin/teknisi/inc/head');
		$this->load->view('admin/teknisi/inc/sidebar');
		$this->load->view('admin/teknisi/data/user',$data);
		$this->load->view('admin/teknisi/inc/footer');
	}
	else
	{
		...
		if($this->M_login->logged_id2() == 'teknisi')
	{
		...
		$this->M_teknisi->input_data_client($data,'client');
		redirect('C_teknisi/informasi_client');
	}
	else
	{
		redirect("C_login");
...
function simpan_penawaran(){
		...
		if($this->M_login->logged_id2() == 'teknisi')
	{
		...
		$this->M_teknisi->input_data_penawaran($data,'penawaran');
		redirect('C_teknisi/penawaran');
	}
	else
	{
		redirect("C_login");
...
function simpan_jasa(){
		...
		if($this->M_login->logged_id2() == 'teknisi')
	{
		...
		$this->M_teknisi->input_data_jasa($data,'jasa');
...
function simpan_v_order(){
		...
		if($this->M_login->logged_id2() == 'teknisi')
	{
		...
		$this->M_teknisi->input_data_jasa($data,'v_order');
		redirect('C_teknisi/v_order');
	}
	else
	{
		redirect("C_login");
		...
		if($this->M_login->logged_id2() == 'teknisi')
	{
        ...
        $this->M_teknisi->input_data_lwo($data,'lwo');
        redirect('C_teknisi/lwo');
	}
	else
	{
		redirect("C_login");
...
function simpan_monitoring(){
		...
		if($this->M_login->logged_id2() == 'teknisi')
	{
        ...
        $this->M_teknisi->input_data_monitoring($data,'monitoring');
        redirect('C_teknisi/monitoring');
	}
	else
	{
		redirect("C_login");
...
function simpan_mekanik(){
		...
		if($this->M_login->logged_id2() == 'teknisi')
	{
		...
		$this->M_teknisi->input_data_mekanik($data,'mekanik');
		redirect('C_teknisi/mekanik');
	}
	else
	{
		redirect("C_login");
...
function simpan_user(){
		...
		if($this->M_login->logged_id2() == 'teknisi')
	{
		...
		$this->M_teknisi->input_data_user($data,'user');
		redirect('C_teknisi/user');
	}
	else
	{
		redirect("C_login");
	...
	$this->M_teknisi->hapus_data_client($where,'client');
	redirect('C_teknisi/informasi_client');
	}
	else
	{
...
function hapus_penawaran($id_penawaran){
	...
	$this->M_teknisi->hapus_data_penawaran($where,'penawaran');
	redirect('C_teknisi/penawaran');
	}
	else
	{
...
function hapus_v_order($id_order){
	...
	$this->M_teknisi->hapus_data_v_order($where,'v_order');
	redirect('C_teknisi/v_order');
	}
	else
	{
...
function hapus_mekanik($id_mekanik){
	...
	$this->M_teknisi->hapus_data_mekanik($where,'mekanik');
	redirect('C_teknisi/mekanik');
	}
	else
	{
	...
	$this->M_teknisi->hapus_data_user($where,'user');
	redirect('C_teknisi/user');
	}
	else
	{
			...
			if($this->M_login->logged_id2() == 'teknisi')
	{
		...
		$where = array('id_client' => $id_client);
		$data['user'] = $this->M_teknisi->edit_data_client($where,'client')->result();
		$this->load->view('admin/teknisi/inc/head');
		$this->load->view('admin/teknisi/inc/sidebar');
		$this->load->view('admin/teknisi/edit/e_in_client',$data);
		$this->load->view('admin/teknisi/inc/footer');
	}
	else
	{
			...
			if($this->M_login->logged_id2() == 'teknisi')
	{
		...
		$data['user'] = $this->M_teknisi->edit_data_jasa($where,'jasa')->result();
		$this->load->view('admin/teknisi/inc/head');
		$this->load->view('admin/teknisi/inc/sidebar');
		$this->load->view('admin/teknisi/edit/e_jasa',$data);
		$this->load->view('admin/teknisi/inc/footer');
	}
	else
	{
...
function edit_penawaran($id_penawaran){
			if($this->M_login->logged_id2() == 'teknisi')
	{
		...
		$where = array('id_penawaran' => $id_penawaran);
		$data['user'] = $this->M_teknisi->edit_data_penawaran($where,'penawaran')->result();
		$data['user2'] = $this->M_teknisi->tampil_data_client()->result();
		$this->load->view('admin/teknisi/inc/head');
		$this->load->view('admin/teknisi/inc/sidebar');
		$this->load->view('admin/teknisi/edit/e_penawaran',$data);
		$this->load->view('admin/teknisi/inc/footer');
	}
	else
	{
...
function edit_v_order($id_order){
			if($this->M_login->logged_id2() == 'teknisi')
	{
		...
		$where = array('id_order' => $id_order);
		$data['user'] = $this->M_teknisi->edit_data_penawaran($where,'v_order')->result();
		$data['user2'] = $this->M_teknisi->tampil_data_client()->result();
		$this->load->view('admin/teknisi/inc/head');
		$this->load->view('admin/teknisi/inc/sidebar');
		$this->load->view('admin/teknisi/edit/e_v_order',$data);
		$this->load->view('admin/teknisi/inc/footer');
	}
	else
	{
			...
			if($this->M_login->logged_id2() == 'teknisi')
	{
		...
		$where = array('id_admin' => $id_admin);
		$data['user'] = $this->M_teknisi->edit_data_user($where,'user')->result();
		$this->load->view('admin/teknisi/inc/head');
		$this->load->view('admin/teknisi/inc/sidebar');
		$this->load->view('admin/teknisi/edit/e_user',$data);
		$this->load->view('admin/teknisi/inc/footer');
	}
	else
	{
	...
	$this->M_teknisi->update_data_client($where,$data,'client');
		redirect('C_teknisi/informasi_client');
	}
...
function edit_mekanik($id_mekanik){
			if($this->M_login->logged_id2() == 'teknisi')
	{
		...
		$where = array('id_mekanik' => $id_mekanik);
		$data['user'] = $this->M_teknisi->edit_data_mekanik($where,'mekanik')->result();
		$data['user2'] = $this->M_teknisi->tampil_data_lwo()->result();
		$this->load->view('admin/teknisi/inc/head');
		$this->load->view('admin/teknisi/inc/sidebar');
		$this->load->view('admin/teknisi/edit/e_mekanik',$data);
		$this->load->view('admin/teknisi/inc/footer');
	}
	else
	{
	...
	$this->M_teknisi->update_data_penawaran($where,$data,'penawaran');
		redirect('C_teknisi/penawaran');
	}
...
function profil_ubah2(){
	...
	$this->M_teknisi->update_data_jasa($where,$data,'v_order');
		redirect('C_teknisi/v_order');
	}
...
function update_data_mekanik(){
	...
	$this->M_teknisi->update_data_mekanik($where,$data,'mekanik');
		redirect('C_teknisi/mekanik');
	}
...
function update_data_user(){
	...
	$this->M_teknisi->update_data_user($where,$data,'user');
		redirect('C_teknisi/user');
	}
