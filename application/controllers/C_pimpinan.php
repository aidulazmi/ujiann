...
class C_pimpinan extends CI_Controller {
	...
	{
		$this->load->view('admin/pimpinan/inc/head');
		$this->load->view('admin/pimpinan/inc/sidebar');
		$this->load->view('admin/pimpinan/das/dashboard');
		$this->load->view('admin/pimpinan/inc/footer');
	}
	else
	{
		redirect("C_login");
		...
		if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$this->load->view('admin/pimpinan/inc/head');
		$this->load->view('admin/pimpinan/inc/sidebar');
		$this->load->view('admin/pimpinan/data/in_client',$data);
		$this->load->view('admin/pimpinan/inc/footer');
	}
	else
	{
		...
		if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$this->load->view('admin/pimpinan/inc/head');
		$this->load->view('admin/pimpinan/inc/sidebar');
		$this->load->view('admin/pimpinan/data/penawaran',$data);
		$this->load->view('admin/pimpinan/inc/footer');
	}
	else
	{
...
public function jasa()
		...
		if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$this->load->view('admin/pimpinan/inc/head');
		$this->load->view('admin/pimpinan/inc/sidebar');
		$this->load->view('admin/pimpinan/data/jasa',$data);
		$this->load->view('admin/pimpinan/inc/footer');
	}
	else
	{
...
public function v_order()
		...
		if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$data['user2'] = $this->M_pimpinan->tampil_data_client()->result();
		$data['user3'] = $this->M_pimpinan->tampil_data_vo();
		$this->load->view('admin/pimpinan/inc/head');
		$this->load->view('admin/pimpinan/inc/sidebar');
		$this->load->view('admin/pimpinan/data/v_order',$data);
		$this->load->view('admin/pimpinan/inc/footer');
	}
	else
	{
...
public function lwo()
		...
		if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$this->load->view('admin/pimpinan/inc/head');
		$this->load->view('admin/pimpinan/inc/sidebar');
		$this->load->view('admin/pimpinan/data/lwo',$data);
		$this->load->view('admin/pimpinan/inc/footer');
	}
	else
	{
...
public function monitoring()
		...
		if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$this->load->view('admin/pimpinan/inc/head');
		$this->load->view('admin/pimpinan/inc/sidebar');
		$this->load->view('admin/pimpinan/data/monitoring',$data);
		$this->load->view('admin/pimpinan/inc/footer');
	}
	else
	{
		...
		if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$this->load->view('admin/pimpinan/inc/head');
		$this->load->view('admin/pimpinan/inc/sidebar');
		$this->load->view('admin/pimpinan/data/mekanik',$data);
		$this->load->view('admin/pimpinan/inc/footer');
	}
	else
	{
		...
		if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$this->load->view('admin/pimpinan/inc/head');
		$this->load->view('admin/pimpinan/inc/sidebar');
		$this->load->view('admin/pimpinan/data/user',$data);
		$this->load->view('admin/pimpinan/inc/footer');
	}
	else
	{
		...
		if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$this->M_pimpinan->input_data_client($data,'client');
		redirect('C_pimpinan/informasi_client');
	}
	else
	{
		redirect("C_login");
...
function simpan_penawaran(){
		...
		if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$this->M_pimpinan->input_data_penawaran($data,'penawaran');
		redirect('C_pimpinan/penawaran');
	}
	else
	{
		redirect("C_login");
...
function simpan_jasa(){
		...
		if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$this->M_pimpinan->input_data_jasa($data,'jasa');
...
function simpan_v_order(){
		...
		if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$this->M_pimpinan->input_data_jasa($data,'v_order');
		redirect('C_pimpinan/v_order');
	}
	else
	{
		redirect("C_login");
		...
		if($this->M_login->logged_id2() == 'pimpinan')
	{
        ...
        $this->M_pimpinan->input_data_lwo($data,'lwo');
        redirect('C_pimpinan/lwo');
	}
	else
	{
		redirect("C_login");
...
function simpan_monitoring(){
		...
		if($this->M_login->logged_id2() == 'pimpinan')
	{
        ...
        $this->M_pimpinan->input_data_monitoring($data,'monitoring');
        redirect('C_pimpinan/monitoring');
	}
	else
	{
		redirect("C_login");
...
function simpan_mekanik(){
		...
		if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$this->M_pimpinan->input_data_mekanik($data,'mekanik');
		redirect('C_pimpinan/mekanik');
	}
	else
	{
		redirect("C_login");
...
function simpan_user(){
		...
		if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$this->M_pimpinan->input_data_user($data,'user');
		redirect('C_pimpinan/user');
	}
	else
	{
		redirect("C_login");
	...
	$this->M_pimpinan->hapus_data_client($where,'client');
	redirect('C_pimpinan/informasi_client');
	}
	else
	{
...
function hapus_penawaran($id_penawaran){
	...
	$this->M_pimpinan->hapus_data_penawaran($where,'penawaran');
	redirect('C_pimpinan/penawaran');
	}
	else
	{
...
function hapus_v_order($id_order){
	...
	$this->M_pimpinan->hapus_data_v_order($where,'v_order');
	redirect('C_pimpinan/v_order');
	}
	else
	{
...
function hapus_mekanik($id_mekanik){
	...
	$this->M_pimpinan->hapus_data_mekanik($where,'mekanik');
	redirect('C_pimpinan/mekanik');
	}
	else
	{
	...
	$this->M_pimpinan->hapus_data_user($where,'user');
	redirect('C_pimpinan/user');
	}
	else
	{
			...
			if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$where = array('id_client' => $id_client);
		$data['user'] = $this->M_pimpinan->edit_data_client($where,'client')->result();
		$this->load->view('admin/pimpinan/inc/head');
		$this->load->view('admin/pimpinan/inc/sidebar');
		$this->load->view('admin/pimpinan/edit/e_in_client',$data);
		$this->load->view('admin/pimpinan/inc/footer');
	}
	else
	{
			...
			if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$data['user'] = $this->M_pimpinan->edit_data_jasa($where,'jasa')->result();
		$this->load->view('admin/pimpinan/inc/head');
		$this->load->view('admin/pimpinan/inc/sidebar');
		$this->load->view('admin/pimpinan/edit/e_jasa',$data);
		$this->load->view('admin/pimpinan/inc/footer');
	}
	else
	{
...
function edit_penawaran($id_penawaran){
			if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$where = array('id_penawaran' => $id_penawaran);
		$data['user'] = $this->M_pimpinan->edit_data_penawaran($where,'penawaran')->result();
		$data['user2'] = $this->M_pimpinan->tampil_data_client()->result();
		$this->load->view('admin/pimpinan/inc/head');
		$this->load->view('admin/pimpinan/inc/sidebar');
		$this->load->view('admin/pimpinan/edit/e_penawaran',$data);
		$this->load->view('admin/pimpinan/inc/footer');
	}
	else
	{
...
function edit_v_order($id_order){
			if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$where = array('id_order' => $id_order);
		$data['user'] = $this->M_pimpinan->edit_data_penawaran($where,'v_order')->result();
		$data['user2'] = $this->M_pimpinan->tampil_data_client()->result();
		$this->load->view('admin/pimpinan/inc/head');
		$this->load->view('admin/pimpinan/inc/sidebar');
		$this->load->view('admin/pimpinan/edit/e_v_order',$data);
		$this->load->view('admin/pimpinan/inc/footer');
	}
	else
	{
			...
			if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$where = array('id_admin' => $id_admin);
		$data['user'] = $this->M_pimpinan->edit_data_user($where,'user')->result();
		$this->load->view('admin/pimpinan/inc/head');
		$this->load->view('admin/pimpinan/inc/sidebar');
		$this->load->view('admin/pimpinan/edit/e_user',$data);
		$this->load->view('admin/pimpinan/inc/footer');
	}
	else
	{
	...
	$this->M_pimpinan->update_data_client($where,$data,'client');
		redirect('C_pimpinan/informasi_client');
	}
...
function edit_mekanik($id_mekanik){
			if($this->M_login->logged_id2() == 'pimpinan')
	{
		...
		$where = array('id_mekanik' => $id_mekanik);
		$data['user'] = $this->M_pimpinan->edit_data_mekanik($where,'mekanik')->result();
		$data['user2'] = $this->M_pimpinan->tampil_data_lwo()->result();
		$this->load->view('admin/pimpinan/inc/head');
		$this->load->view('admin/pimpinan/inc/sidebar');
		$this->load->view('admin/pimpinan/edit/e_mekanik',$data);
		$this->load->view('admin/pimpinan/inc/footer');
	}
	else
	{
	...
	$this->M_pimpinan->update_data_penawaran($where,$data,'penawaran');
		redirect('C_pimpinan/penawaran');
	}
...
function profil_ubah2(){
	...
	$this->M_pimpinan->update_data_jasa($where,$data,'v_order');
		redirect('C_pimpinan/v_order');
	}
...
function update_data_mekanik(){
	...
	$this->M_pimpinan->update_data_mekanik($where,$data,'mekanik');
		redirect('C_pimpinan/mekanik');
	}
...
function update_data_user(){
	...
	$this->M_pimpinan->update_data_user($where,$data,'user');
		redirect('C_pimpinan/user');
	}
