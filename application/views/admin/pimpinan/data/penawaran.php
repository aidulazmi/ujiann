        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <a href="<?php echo site_url('C_pimpinan/penawaran_cetak')?>" target="_blank" class="btn btn-app bg-success" >
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <!-- <td>
                      ...
                      <a class="btn btn-danger btn-sm" href="<?php echo site_url('C_pimpinan/hapus_penawaran/'.$u->id_penawaran);?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">
    ...
    <!-- /.content -->
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <form action="<?php echo site_url('C_pimpinan/simpan_penawaran')?>" method="POST">
                <div class="card-body">
