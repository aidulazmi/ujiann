        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <a href="<?php echo site_url('C_pimpinan/v_order_cetak')?>" target="_blank" class="btn btn-app bg-success" >
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                   ...
                   <!--  <td>
                    <a class="btn btn-info btn-sm" href="<?php echo site_url('C_pimpinan/edit_v_order/'.$u->id_order);?>">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Ubah
                      </a>
                      <a class="btn btn-danger btn-sm" href="<?php echo site_url('C_pimpinan/hapus_v_order/'.$u->id_order);?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">
    ...
    <!-- /.content -->
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <form action="<?php echo site_url('C_pimpinan/simpan_v_order')?>" method="POST">
                <div class="card-body">
