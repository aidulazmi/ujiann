              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                     <a class="btn btn-info btn-sm" href="<?php echo site_url('C_pimpinan/edit_user/'.$u->id_admin);?>">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Ubah
                      </a>
                      <a class="btn btn-danger btn-sm" href="<?php echo site_url('C_pimpinan/hapus_user/'.$u->id_admin);?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">
    ...
    <!-- /.content -->
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <form action="<?php echo site_url('C_pimpinan/simpan_user')?>" method="POST">
                <div class="card-body">
