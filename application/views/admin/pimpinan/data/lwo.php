        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <a href="<?php echo site_url('C_pimpinan/lwo_cetak')?>" target="_blank" class="btn btn-app bg-success" >
    ...
    <!-- /.content -->
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <form enctype="multipart/form-data" action="<?php echo site_url('C_pimpinan/simpan_lwo')?>" method="POST">
                <div class="card-body">
