        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <form action="<?php echo site_url('c_admin/update_data_v_order')?>" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                        ...
                        <select class="form-control" name="status_verifikasi" id="status_verifikasi">
                          <option value="<?php echo $u->status_verifikasi ?>" selected><?php echo $u->status_verifikasi ?></option>
