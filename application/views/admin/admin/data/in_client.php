        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <a href="<?php echo site_url('C_admin/informasi_client_cetak')?>" target="_blank" class="btn btn-app bg-success" >
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      ?></td>
                    <td>
                      <a class="btn btn-info btn-sm" href="<?php echo site_url('C_admin/edit_client/'.$u->id_client);?>">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Ubah
                      </a>
                      <a class="btn btn-danger btn-sm" href="<?php echo site_url('C_admin/hapus_client/'.$u->id_client);?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">
    ...
    <!-- /.content -->
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <form action="<?php echo site_url('C_admin/simpan_client')?>" method="POST">
                <div class="card-body">
