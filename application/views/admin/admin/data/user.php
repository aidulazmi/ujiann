        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <a href="<?php echo site_url('C_admin/user_cetak')?>" target="_blank" class="btn btn-app bg-success" >
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                     <a class="btn btn-info btn-sm" href="<?php echo site_url('C_admin/edit_user/'.$u->id_admin);?>">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Ubah
                      </a>
                      <a class="btn btn-danger btn-sm" href="<?php echo site_url('C_admin/hapus_user/'.$u->id_admin);?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">
