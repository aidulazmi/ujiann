        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <a href="<?php echo site_url('C_admin/monitoring_cetak')?>" target="_blank" class="btn btn-app bg-success" >
                  ...
                  <tr>
                    ...
                    <td>
                     <!--<a class="btn btn-info btn-sm" href="<?php echo site_url('C_admin/edit_jasa/'.$u->id_jasa);?>">
                      ...
                      <a class="btn btn-danger btn-sm" href="<?php echo site_url('C_admin/hapus_monitoring/'.$u->id_monitoring);?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">
    ...
    <!-- /.content -->
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <form enctype="multipart/form-data" action="<?php echo site_url('C_admin/simpan_monitoring')?>" method="POST">
                <div class="card-body">
