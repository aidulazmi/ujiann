...
<head>
	...
	<!-- //Meta tag Keywords -->
	<!--/Style-CSS -->
	<link rel="stylesheet" href="<?=base_url();?>/asset/login/css/style.css" type="text/css" media="all" />
	<!--//Style-CSS -->
</head>
...
<body>
	...
	<section class="w3l-forms-23">
		<div class="forms23-block-hny">
			<div class="wrapper">
				<h1>Sistem Informasi Pelayanan Jasa Alat Berat <br>
				PT. Servitama Internusa Pekanbaru</h1>
					...
					<div class="form23">
						<div class="main-bg">
							...
							<div class="speci-login first-look">
								<img src="<?=base_url();?>/asset/login/images/user.png" alt="" class="img-responsive">
							</div>
						</div>
