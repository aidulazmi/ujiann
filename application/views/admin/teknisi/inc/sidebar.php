    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="<?php echo site_url('C_teknisi/v_order')?>" class="dropdown-item dropdown-footer">Semua Masa Tempo</a>
        </div>
      </li>
      <li class="nav-item">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('C_teknisi/index')?>" class="nav-link js-scroll-trigger">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('C_teknisi/informasi_client')?>" class="nav-link js-scroll-trigger">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('C_teknisi/mekanik')?>" class="nav-link js-scroll-trigger">
              <i class="nav-icon fas fa-toolbox"></i>
              <p>
                Data Mekanik
              </p>
