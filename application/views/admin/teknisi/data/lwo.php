                  ...
                  <tr>
                    ...
                    <td>
                     <!--<a class="btn btn-info btn-sm" href="<?php echo site_url('C_teknisi/edit_jasa/'.$u->id_jasa);?>">
                      ...
                      <a class="btn btn-danger btn-sm" href="<?php echo site_url('C_teknisi/hapus_lwo/'.$u->id_lwo);?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">
    ...
    <!-- /.content -->
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <form enctype="multipart/form-data" action="<?php echo site_url('C_teknisi/simpan_lwo')?>" method="POST">
                <div class="card-body">
