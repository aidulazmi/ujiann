              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-info btn-sm" href="<?php echo site_url('C_teknisi/edit_penawaran/'.$u->id_penawaran);?>">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Ubah
                      </a>
                      <a class="btn btn-danger btn-sm" href="<?php echo site_url('C_teknisi/hapus_penawaran/'.$u->id_penawaran);?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">
    ...
    <!-- /.content -->
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <form action="<?php echo site_url('C_teknisi/simpan_penawaran')?>" method="POST">
                <div class="card-body">
