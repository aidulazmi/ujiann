                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end" id="navbarSupportedContent">
                            <ul class="navbar-nav align-items-center">
                                <li class="nav-item active">
                                    <a class="nav-link" href="<?php echo site_url('C_client/index')?>">Home</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('C_client/loginsl')?>">Layanan Jasa</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('C_client/loginsl')?>">Monitoring</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('C_client/aboutsl')?>">About US</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('C_client/loginsl')?>">Login</a>
                                </li>
<!--                                 <li class="nav-item">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5">
                    <div class="section_tittle text-center">
                        ...
                        <br>
                        <h6>Kami Merupakan Sebuah Perusahan Yang Bergerak di Bidang Jasa Fabrikasi Khusunya Pekerjaan Rekondisi Yang Meliputi Pemeliharaan, Perbaikan, Modifikasi dan Rebuild Pada Bagian Kontruksi dan Mesin Peralatan Industri / Alat Berat</h6>
                    </div>                    
                </div>
            </div>
        </div>
    ...
    <section class="member_counter">
        <div class="container">
            <div class="row justify-content-center">
                <p class="redtext">Keunggulan Kami</p>
            </div>
            <div class="row">
