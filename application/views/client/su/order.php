        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <form enctype="multipart/form-data" action="<?php echo site_url('C_client/simpan_v_order')?>" method="post">

                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">ID Jasa</label>
                    <input type="text" class="form-control" value="<?php echo $u->id_jasa ?>" id="exampleInputEmail1" placeholder="client" name="id_jasa" readonly required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Email</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Silahkan Masukkan Email" name="email" required>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Layanan Jasa</label>
                    <input type="text" class="form-control" value="<?php echo $u->layanan_jasa ?>" id="exampleInputEmail1" placeholder="Layanan Jasa" name="layanan_jasa" readonly required>
                  </div>
